          ...
          <div className="min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
              <div>
                ...
                <img src={Image} className="max-w-sm mt-8 rounded-lg laptop:w-[10%] laptop:h-[1%] w-full mx-auto shadow-2xl laptop:float-right" />

                <p className="pb-2 pt-6 font-notbold laptop:max-w-[87%]">
