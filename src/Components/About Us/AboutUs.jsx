      ...
      <div className="text-[#010037]">
        <div className="hero-content flex-col lg:flex-row-reverse mt-[6rem]">
          ...
          <div className="my-4 laptop:w-[77%]">
            ...
            <div className="laptop:flex mb-2">
              {/* <img src={Humphrey1} className="laptop:max-w-sm mb-4 laptop:hidden rounded-sm shadow-2xl" /> */}
              <img src={Humphrey1} className="laptop:max-w-[27rem] mr-8 laptop:flex rounded-sm shadow-2xl" />
              <div>
                ...
                <p className="py-1 leading-relaxed w-full">
            ...
            <div className="laptop:flex mb-4">
              {/* <img src={Humphrey2} className="laptop:max-w-sm mb-4 laptop:hidden rounded-sm shadow-2xl" /> */}
              <img src={Humphrey2} className="laptop:max-w-[27rem] mr-8 laptop:flex rounded-sm shadow-2xl" />
              <div>
