            ...
            <div className="min-h-screen bg-base-200">
              <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                  ...
                  <p className="pb-2 pt-6 mt-4 font-notbold laptop:max-w-[80%] laptop:pr-4 leading-[2.5rem]">
                  ...
                  <p className="pt-2 pb-6 font-notbold laptop:max-w-[87%] leading-[2.5rem]">
                    <a className='link hover:no-underline block text-blue-500'>GUARDIAN mini ROV Specification</a>
                    <a className='link hover:no-underline block text-blue-500'>SeaEye FALCON ROV</a>
                    <a className='link hover:no-underline block text-blue-500'>Sub Atlantic MOJAVE ROV</a>
                    <a className='link hover:no-underline block text-blue-500'>Turtuga ROV</a>
                    <a className='link hover:no-underline block text-blue-500'>Inuktun MaggHD ROV</a>
                  </p>
                </div>
              </div>
            </div>
